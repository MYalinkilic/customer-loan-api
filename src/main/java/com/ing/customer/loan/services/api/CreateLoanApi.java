...
@Validated
@Tag(name = "createLoan", description = "the createLoan API")
@RequestMapping("/ing/v1B/customer/loan/api")
public interface CreateLoanApi {

    /**
     * POST /createLoan : Create a new loan
     *
     * @param customerLoanReq  (required)
    ...
    ResponseEntity<Object> createLoanPost(
        @Parameter(name = "CustomerLoanReq", description = "", required = true) @Valid @RequestBody CustomerLoanReq customerLoanReq
    );
