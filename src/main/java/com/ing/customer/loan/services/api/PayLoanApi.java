...
@Validated
@Tag(name = "payLoan", description = "the payLoan API")
@RequestMapping("/ing/v1B/customer/loan/api")
public interface PayLoanApi {

    /**
     * POST /payLoan : pay Loan
     *
     * @param payLoanReq  (required)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Created", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = PayLoanRes.class))
            }),
    ...
    ResponseEntity<Object> payLoanPost(
        @Parameter(name = "PayLoanReq", description = "", required = true) @Valid @RequestBody PayLoanReq payLoanReq
    );
